Farmer Problem using depth-first search - displays a solution to the farmer problem, including search strategy details, using a depth-first search approach.
